...
describe('Space Age', () => {
  test('throw error when asking for pluto', () => {
    expect(() => age('pluto', 3454000000000)).toThrowError('Unvalid planet name or time!')
  });
  test('throw error when asking for pluto', () => {
    expect(() => age('mars', true)).toThrowError('Unvalid planet name or time!')
  });
